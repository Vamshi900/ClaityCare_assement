...
from extraction.validator import validate_schema, validate_rule_tree_integrity, compare_with_ground_truth, RULE_SCHEMA
from extraction.extractor import run_pipeline


PDF_PATH = str(Path(__file__).parent.parent.parent / "full-stack-feb" / "oscar.pdf")
GROUND_TRUTH_PATH = str(Path(__file__).parent.parent.parent / "full-stack-feb" / "oscar.json")
